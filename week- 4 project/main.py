...
def call_api(query):
    ...
    api_url = "https://2tl08u7oih.execute-api.us-east-1.amazonaws.com/dev/bedrockchatAPIResource"
...
# Streamlit app
def main():
    st.set_page_config(page_title="RAG Document Reader", page_icon="🧠", layout="wide")
